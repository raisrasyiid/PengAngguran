<div class="container-fluid pt-5">
    <div class="latest-product__text mb-4">
                    ...
                    <tbody>
                        ...
                        foreach ($toko as $val) { ?>
                            <tr>
                                ...
                                <td> <a href="<?php echo site_url('toko/add/' . $toko->idToko); ?>" class="btn btn-outline-primary">Proses Validasi Dokumen</a>
                                </td>
                                <!-- <td>
        ...
        <!-- <a href="<?php echo site_url('toko/add/' . $toko->idToko); ?>" class="btn btn-outline-primary">Proses Validasi Dokumen</a> -->
    </div>
